...
LocalEvent::LocalEvent(Scalar color, Point roiPos, int frameHeight, int frameWidth, const int *roiSize):mLeColor(color){
...
void LocalEvent::computeMassCenter(){
    ...
    for (it = mLeRoiList.begin(); it != mLeRoiList.end(); ++it){
