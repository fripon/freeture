...
int main(int argc, const char ** argv){
	...
	/*const vector<string> kw = {"DATA_PATH","ACQ_SPRITE_ENABLED", "SPRITE_MASK_PATH", "STATION_NAME"};
	
	SpriteReader toto;
	
	for(auto it=kw.begin(); it!=kw.end(); it++)
		cout<<*it<<" "<<toto.extractValueForKeyword(*it)<<endl;
            ...
            switch(mode){
                ...
                case 3 :
...

                    {
                        ...
                        /*const unsigned long DEUSEXMACHINA = 300;//cfg.getDetParam().ACQ_BUFFER_SIZE * cfg.getCamParam().ACQ_FPS;
                        vector<Frame> frameSprite(DEUSEXMACHINA);*/
